/*function to perform encryption on a block of data
containing 256 bits*/
/*  Main program */
#include<stdio.h>
#include<math.h>
...
/* Function to encrypt message using
	MSA algorithm(Meheboob, Saima and Asoke)*/
	...
	/* system("del TEMP.DAT"); Removing temporay file */
	}
